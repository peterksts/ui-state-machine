...
export const Tasks: Task[] = [
  {
    ...
    "execution": {"dsl": [{"dsl": "pipe {{table_src}} | bin auto -c {{column}} -k {{input}}"}, {"dsl": "rename column -f {{column}}_bin_factor1,{{column}}_bin1 -t {{column}}_clus_bucket_group_of_{{input}},{{column}}_clus_bucket_range_of_{{input}} | as {{table_dst}}"}]},
    "completion": [{
      "dsl": [{"dsl": "pipe {{table_dst}} | countby {{column}}_clus_bucket_group_of_{{input}},{{column}}_clus_bucket_range_of_{{input}} "}, {"dsl": "rename column -f 3 -t Count | distinct | sortby 1 | as {{table_dst}}_bucket_summary"}],
      ...
      "dsl": "pipe {{table_dst}} | columns {{column}}_clus_bucket_group_of_{{input}},{{column}}_clus_bucket_range_of_{{input}} | describe distribution",
    ...
    "execution": {"dsl": [{"dsl": "pipe {{table_src}} | bin quantile -c {{column}} -q {{input}}"}, {"dsl": "rename column -f {{column}}_bin_factor1,{{column}}_bin1 -t {{column}}_pct_bucket_group_of_{{input}},{{column}}_pct_bucket_range_of_{{input}} | as {{table_dst}}"}]},
    "completion": [{
      "dsl": [{"dsl": "pipe {{table_dst}} | countby {{column}}_pct_bucket_group_of_{{input}},{{column}}_pct_bucket_range_of_{{input}} "}, {"dsl": "rename column -f 3 -t Count | distinct | sortby 1 | as {{table_dst}}_bucket_summary"}],
      "annotationSet": "{{table_dst}}.summary",
      "row": "all"
    }, {
      "dsl": "schema --filter {{table_dst}}",
      ...
      "dsl": "pipe {{table_dst}} | columns {{column}}_pct_bucket_group_of_{{input}},{{column}}_pct_bucket_range_of_{{input}} | describe distribution",
      "annotationSet": "{{table_dst}}.distribution",
      "row": "bycolumn",
      "subsetColumn": {"column": "name"},
      "columns": {"ignore": true, "columns": "type"}
    ...
    "parameters": {
      ...
      "execution": {"dsl": [{"dsl": "pipe {{table_src}} | bin range -c {{column}} -r {{input}}"}, {"dsl": "rename column -f {{column}}_bin_factor1,{{column}}_bin1 -t {{column}}_rng_bucket_group_of_{{input}},{{column}}_rng_bucket_range_of_{{input}} | as {{table_dst}}"}]},
      "completion": [{
        "dsl": [{"dsl": "pipe {{table_dst}} | countby {{column}}_rng_bucket_group_of_{{input}},{{column}}_rng_bucket_range_of_{{input}} "}, {"dsl": "rename column -f 3 -t Count | distinct | sortby 1 | as {{table_dst}}_bucket_summary"}],
        "annotationSet": "{{table_dst}}.summary",
        "row": "all"
      }, {
        "dsl": "schema --filter {{table_dst}}",
        ...
        "dsl": "pipe {{table_dst}} | columns {{column}}_rng_bucket_group_of_{{input}},{{column}}_rng_bucket_range_of_{{input}} | describe distribution",
        "annotationSet": "{{table_dst}}.distribution",
        "row": "bycolumn",
        "subsetColumn": {"column": "name"},
        "columns": {"ignore": true, "columns": "type"}
  ...
  },
  {
    ...
    "execution": {"dsl": [{"dsl": "pipe {{table_src}} | transpose pivot -i {{input}} -c {{columns}} -o {{agg}}_{{output}} -a {{agg}}:{{output}}"}, {"dsl": "as {{table_dst}}"}]},
    "completion": [{
      "dsl": "schema --filter {{table_dst}}",
      "annotationSet": "{{table_dst}}.schema",
      "row": "bycolumn",
    ...
    "execution": {"dsl": [{"dsl": "pipe {{table_src}} | transpose unpivot -i {{input}} -o {{output}}_label"}, {"dsl": "rename column -f transposed_1 -t {{output}}_value | as {{table_dst}}"}]},
    "completion": [{
      "dsl": "schema --filter {{table_dst}}",
      "annotationSet": "{{table_dst}}.schema",
      "row": "bycolumn",
...

  {
    ...
    "execution": {"dsl": "analytics_model_train_binclass_bakeoff --train_data {{training_set}} --train_tgt {{target_feature}} --train_ftr {{feature_set}}"},
    "completion": [{
      "dsl": "model list",
